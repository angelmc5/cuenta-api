...
namespace cuenta_api.Repositorio
{
    public class ReporteRepositorio : IReporteRepositorio
    {
        ...
        public ICollection<Reporte> GetReporte(DateTime inicioFecha, DateTime finFecha)
        {
            ...
            return _bdd.Reporte.FromSqlRaw(sqlQuery, startDateParam, endDateParam).ToList();
